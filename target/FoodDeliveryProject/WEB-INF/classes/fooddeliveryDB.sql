...
(
    ...
    courier_phone character varying(13) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    customer_phone character varying(13) COLLATE pg_catalog."default" NOT NULL,
    account_registered_time timestamp without time zone DEFAULT 'CURRENT_TIMESTAMP',
...
(
    ...
    product_ordered_time timestamp without time zone DEFAULT 'CURRENT_TIMESTAMP'
);
