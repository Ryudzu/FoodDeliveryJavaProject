...
public final class Update {
    ...
    private static void updateCartDataColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateCourierDataColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateCustomerCartColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateCustomerDataColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateOrderDataColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateProductAndOrderColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateProductCategoryDataColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateProductDataColumns(int columnId) {
        int choice = input.nextInt();
    ...
    private static void updateReviewDataColumns(int columnId) {
        int choice = input.nextInt();
