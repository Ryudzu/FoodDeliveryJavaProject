...
public final class ProductDataValidator {
    ...
    public void validatePrice(double price) throws PersonalExceptions {
        if (price > 0 && price < 1000)
            ...
            throw new PersonalExceptions("Стоимость товара в ProductData невалидна! Она не может быть отрицательной, равной нулю и должна иметь два знака после запятой (максимально допустимое значение 1000).");
    }
    ...
    public void validateProductCategoryId(int productCategoryId) throws PersonalExceptions {
        if (productCategoryId > 0)
            ...
            throw new PersonalExceptions("ID категории товара в ProductData невалидный! Он не может быть отрицательным или равным нулю.");
    }

    public void validateProductRating(int productRating) throws PersonalExceptions {
        if (productRating >= 1 && productRating < 6)
            product.setProductRating(productRating);
        else
            throw new PersonalExceptions("Рейтинг товара в ProductData невалидный! Он не может быть меньше 1 и больше 5.");
    }
    ...
    public void validateProductTitle(String productTitle) throws PersonalExceptions {
        ...
        if (mt.matches() && productTitle.length() <= 30)
            product.setProductTitle(productTitle);
        else
            throw new PersonalExceptions("Название товара в ProductData невалидно! Оно не должно содержать в себе цифр и должно быть больше 3-х символов (максимально допустимое значение 30 символов).");
    }
}
