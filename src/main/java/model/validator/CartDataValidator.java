...
public final class CartDataValidator {
    ...
    public void validateAmount(int amount) throws PersonalExceptions {
        if (amount >= 0 && amount <= 99)
            ...
            throw new PersonalExceptions("Количество товаров в CartData невалидно! Оно не может быть отрицательным или больше 99.");
    }
    ...
    public void validateProductDataId(int productDataId) throws PersonalExceptions {
        if (productDataId > 0)
            ...
            throw new PersonalExceptions("ID товара в CartData невалидный! Он не может быть отрицательным или равным нулю.");
    }
    ...
    public void validateCustomerCartId(int customerCartId) throws PersonalExceptions {
        if (customerCartId > 0)
            ...
            throw new PersonalExceptions("ID пользователя в CartData невалидный! Он не может быть отрицательным или равным нулю.");
    }
}
